...
class DHT11:
    'DHT11 sensor reader class for DIGI xbee Modules'
    ...
    def read(self):
        ...
        self.__xbee_device.set_io_configuration(IOLine.DIO0_AD0, IOMode.DIGITAL_OUT_HIGH)
        time.sleep(0.05)

        
        # pull down to low
        #self.__send_and_sleep(RPi.GPIO.LOW, 0.02)
        self.__xbee_device.set_io_configuration(IOLine.DIO0_AD0, IOMode.DIGITAL_OUT_LOW)
        time.sleep(0.02)

        #change to input using pull up
        #RPi.GPIO.setup(self.__pin, RPi.GPIO.IN, RPi.GPIO.PUD_UP)
        self.__xbee_device.set_io_configuration(IOLine.DIO0_AD0, IOMode.DIGITAL_IN)
    ...
    def __collect_input(self):
        ...
        while True:
            ...
            current=self.__xbee_device.get_dio_value(IOLine.DIO0_AD0)
